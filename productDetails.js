...
const displayData = () => {
    ...
    Right.innerHTML = ` <h3 class="poductName">${product.brand}</h3>
      ...
      <p class="paya">Colour: ${product.color} </p>
    ...
    //Add to cart
    var cart = JSON.parse(localStorage.getItem("cartls")) || [];
...
localStorage.setItem("similarData", JSON.stringify(items));
    ...
    function displaySimilarProducts(arr){
        arr.forEach(function(Item) {
          ...
          var div1 = document.getElementById("SimilarProductContainer");
          div1.append(div);
